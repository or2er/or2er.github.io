    ...
    >
      ...
      <div className="flex-row grid grid-cols-2 pt-56 ">
        <p className="text-2xl/normal xl:text-4xl/normal pr-16 xl:pr-24">
          We are five enthusiastic developers, aged 19-20, form the or2er team.
          All of whom are{" "}
          <span className="text-[#F10000] underline underline-offset-8">
            dedicated to using AI to create solutions
          </span>{" "}
          that makes a positive impact. Each member brings their own skills and
          ideas, working together seamlessly to push the boundaries of AI.
        </p>
